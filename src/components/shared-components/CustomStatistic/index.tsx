...
const Value = (props: { size: any; value: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined; }) => {
	let value;
	switch (props.size) {
		case 'lg':
...
export const CustomStatistic = (props: { size: any; value: any; title: any; }) => {
