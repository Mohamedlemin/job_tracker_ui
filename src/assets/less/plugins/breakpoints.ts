...
function lookupVariable(context: { frames: any; importantScope: any }, variableName: string) {
	const { frames, importantScope } = context

	return tree.Variable.prototype.find(frames, (frame: { variable: (arg0: any) => {} }) => {
...
function rulesetToMap(context: any, { ruleset: { rules } } = { ruleset: { rules: [] } }) {
	const map = {}
...
function getBreakpoints(context: any, breakpoints: { ruleset: { rules: never[] } } | undefined) {
	if (!breakpoints) {
...
functions.add('breakpoint-next', function ({ value: breakpointName }: any, breakpoints: any) {
...
functions.add('breakpoint-min', function ({ value: breakpointName }: any, breakpoints: any) {
	const breakpointsMap = getBreakpoints(this.context, breakpoints)
	const breakpointNames = Object.keys(breakpointsMap)
	const breakpointIndex = breakpointNames.indexOf(breakpointName)
...
functions.add('breakpoint-max', function ({ value: breakpointName }: any, breakpoints: any) {
	const breakpointsMap = getBreakpoints(this.context, breakpoints)
	const breakpointNames = Object.keys(breakpointsMap)
	const breakpointIndex = breakpointNames.indexOf(breakpointName)
...
functions.add('breakpoint-infix', function ({ value: breakpointName }: any, breakpoints: any) {
	const breakpointsMap = getBreakpoints(this.context, breakpoints)
	const breakpointNames = Object.keys(breakpointsMap)
	const breakpointIndex = breakpointNames.indexOf(breakpointName)
