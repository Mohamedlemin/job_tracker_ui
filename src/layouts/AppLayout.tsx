...
const AppContent = styled.div<{ isNavTop: boolean }>`
...
export const AppLayout = ({ navCollapsed, navType, direction, children }: { navCollapsed: boolean, navType: string, direction: string, children: React.ReactNode }) => {

    const location = useLocation();

    const currentRouteInfo = utils.getRouteInfo(navigationConfig, location.pathname)
    console.log(useBreakpoint());
    const screens = utils.getBreakpoints(useBreakpoint());
